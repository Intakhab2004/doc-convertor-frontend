...
export const tools = [
    { icon: "✦", title: "PDF to Image Convertor", category: "Documents", desc: "A powerful tool that lets you select specific pages and convert them into high-quality images instantly. All selected pages are packaged into a single ZIP file for quick download.", redirect: "/tools/pdf-to-img", users: "3.2K", rating: 4.8, color: "#8b5cf6" },
    { icon: "◈", title: "DataFlow Studio", category: "Analytics", desc: "Visual pipeline builder to ingest, transform, and visualize complex datasets with zero code required.", redirect: "#", users: "2.1K", rating: 4.7, color: "#06b6d4" },
    { icon: "⬡", title: "ContentForge", category: "Marketing", desc: "AI-driven content generation with brand-voice matching, SEO optimization, and multi-platform export.", redirect: "#", users: "4.5K", rating: 4.9, color: "#ec4899" },
    { icon: "◆", title: "SecureVault", category: "Security", desc: "End-to-end encrypted password manager with zero-knowledge architecture and biometric unlock.", redirect: "#", users: "1.8K", rating: 4.6, color: "#f59e0b" },
    { icon: "◇", title: "CloudSync Pro", category: "Productivity", desc: "Unified file synchronisation across 30+ cloud providers with intelligent conflict resolution.", redirect: "#", users: "2.9K", rating: 4.5, color: "#10b981" },
    { icon: "◻", title: "MockFlow", category: "Design", desc: "Rapid wireframing and interactive prototype builder with built-in user-testing simulation.", redirect: "#", users: "1.4K", rating: 4.7, color: "#6366f1" },
]
